...
└── 30-maker-uptime-band-tightening-design.md # 阶段 6 ±10bp 带内 uptime 渐进参数收缩设计与判据
```
...
| [30-maker-uptime-band-tightening-design.md](30-maker-uptime-band-tightening-design.md) | 阶段 6：SIP-5A ±10bp 带内 uptime 达标的渐进参数收缩设计与预注册判据 | 开发参考 |
